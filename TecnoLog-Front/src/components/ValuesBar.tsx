...
const ValuesBar: React.FC<ValuesBarProps> = ({ stockValue, stockReal, lowStock, zeroStock }) => {
    return (
        <div className="w-auto bg-[#e0e0e0] h-24 rounded-t-none rounded-2xl flex items-center justify-end top-20 gap-10">
            ...
            <div className="mt-3 flex-col items-center justify-center text-center">
                <p className="font-bold">{ stockReal }</p>
                <p className="text-md">Estoque</p>
            </div>
